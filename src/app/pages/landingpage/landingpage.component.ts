...
import { ValoksSectionComponent } from './valoks-section/valoks-section.component';
...
@Component({
  ...
  imports: [SectionComponent, FooterComponent, AboutMeComponent, ValoksSectionComponent],
